...
//					"។ៗ៕៚៙៖\n";
            ...
            if (isCodepage) {
                ...
                PrinterHelper.country(codepage, languageEncode);
            }
            PrinterHelper.autLinePlus(edX.getText().toString(), edY.getText().toString(), edPageWidth.getText().toString(), formatfont, cbTextformatBold.isChecked(), cbSetmag.isChecked(), sText);
            if ("Khemr".equals(codepage)){
                PrinterHelper.setKhmerEnd();
                LanguageEncode="gb2312";
            }
